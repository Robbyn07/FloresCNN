...
from apiCNN.models import TablaFlores
...
def obtener_imagen(data_url, base_dir):
    ...
    prediccion = modeloCNN.predict(base_dir + '/media/' + _filename)
    obj_imagen = TablaFlores(int(dtm.timestamp()), _filename, prediccion.get('pred'),
...
def listar_registros():
    imagenes = TablaFlores.objects.all()
